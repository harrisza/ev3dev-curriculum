...
#     200 degrees / second  -->  traveled 23 inches  -->  2.3 inches / second
#     300 degrees / second  -->  traveled 33.5 inches  -->  3.35 inches / second
#     400 degrees / second  -->  traveled 43 inches  -->  4.3 inches / second
#   Tests @ 5 seconds:
...
def main():
    ...
    while time_s != 0:
        ...
        time_s = int(input("Enter a distance (inches): "))/speed_sp
